...
const PrivacyPolicy = () => (
    <div className="width-limiter">
        <Helmet>
            <link rel="canonical" href="https://dictionary.lingdocs.com/privacy-policy" />
            <meta name="description" content="Privacy Policy for the LingDocs Pashto Dictionary" />
            <title>Privacy Policy - LingDocs Pashto Dictionary</title>
        </Helmet>
